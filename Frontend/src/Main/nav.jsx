            ...
            <div className="fixed top-5 z-30  2xl:px-7 xl:px-6 sm:px-4 px-2   w-screen text-white">
                <div className="flex items-center  justify-between">
                    ...
                    <div className="flex justify-center items-center gap-3 ">
                        ...
                        {openHam && (
                            <div ref={hamRef} className=" fixed inset-0  z-50 w-[350px] px-4 text-white bg-[#000000] h-screen justify-self-end rounded-l-[30px] border border-gray-700">

                                <div className="lg:hidden bg-gray-600/30 p-1 border border-gray-600 rounded-lg w-[40px] flex  justify-center items-center justify-self-end mt-6" onClick={handleClickHamburger}>
                                ...
                                <div className="mt-10">
                                    {navItems.map((items) => {
                                        return (<ul key={items.id}>
                                            <div>
...

                                                    {
                                                        items.hasDropdown && (
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <span >
                                                                        <svg className={`${openDropdownId === items.id ? "rotate-180 mb-1 transition-all duration-200" : "animate-bounce"}`} width={24} height={24} viewBox="0 0 24 24">
                                                ...
                                                <hr className="border w-[50%] justify-self-center border-white/20" />
                                    ...
                                    <MainCTAbutton className="w-full mt-6 justify-center" />
                                </div>
                                <div className="flex flex-col justify-center items-center mt-5 gap-2 border  p-5 rounded-3xl bg-white/10 border-gray-700">
                                    <div className=" font-circular-web flex justify-center items-center gap-3">
                                        <img className="h-[70px] w-[70px]" src="https://res.cloudinary.com/dggoaxqxl/image/upload/q_auto/f_auto/v1779801993/Untitled_design_3_-Photoroom_hkidic.webp" alt="" />

                                        <div className="flex flex-col gap-1">
                                            <span className="text-2xl">CodeSarthi</span>
