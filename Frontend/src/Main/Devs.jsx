          ...
          <div className='w-full flex flex-col '>
            ...
            <div className='flex flex-col min-[450px]:flex-row gap-2 justify-between items-start mt-5'>
              <div className='flex flex-col sm:flex-row lg:flex-col xl:flex-row  gap-2 min-[450px]:gap-5 items-center w-full min-[450px]:w-1/2 sm:w-auto lg:w-1/2 justify-start'>
                ...
                <div onClick={() => Navigate("/fuel-my-next-commit")} className='text-white/45 flex items-center gap-2 border px-5 py-2 rounded-full border-white/30 hover:border-white/70 hover:text-white/70 transition-all duration-300 cursor-pointer relative z-20 xl:w-auto w-full sm:w-auto lg:w-full'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
