...
const Devs = () => {
  ...
  return (
    <div className='flex h-[60vh]     bg-[linear-gradient(rgba(255,255,255,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.04)_1px,transparent_1px)]
    bg-[size:40px_40px] rounded-xl flex   items-starts justify-center '>

      <div className='w-1/2  flex items-center justify-center'>
        <div className='w-full  flex flex-col items-center justify-center'>
          <div className='pl-10 text-[#f9f9f9] font-poppins font-extrabold text-7xl  justify-start'>
            The Founder's Desk
          </div>
      ...
      <div className='w-1/2  flex flex-col gap-10 mt-[150px]  mr-20 items-center justify-center'>
        <p className='text-[#f9f9f9] font-poppins font-extralight text-xl  justify-start'>
