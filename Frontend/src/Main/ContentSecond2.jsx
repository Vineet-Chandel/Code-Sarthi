...
const ContentSecond2 = () => {
    ...
    return (
        <div
            ...
            className="w-full bg-black flex flex-col items-center py-20 px-4 md:px-8 font-poppins h-auto">
            ...
            <div className="w-full max-w-[1500px] mb-14 mt-[70px] text-center md:text-start">
                ...
                <h2 className="font-semibold text-3xl sm:text-4xl lg:text-5xl leading-tight text-white mb-4">
                    <img className='mb-10 sm:mr-5 w-15 h-15' src="https://neon.com/_next/static/media/branching.0s3o1zhuulh70.svg?dpl=dpl_2krqjZKb71veXn3xx7f5ScK8b3Aj" alt="" /> Frequently asked questions
                </h2>
            ...
            <div className="w-full max-w-[1500px] border-t border-white/10 pt-20">
                <div className="text-center md:text-start mb-12">
                    <img className='mb-10 sm:mr-5 w-15 h-15' src="https://neon.com/_next/static/media/features.0m~9f17vyqjh5.svg?dpl=dpl_2krqjZKb71veXn3xx7f5ScK8b3Aj" alt="" />
