            ...
            <section className="bg-transparent text-white flex flex-col  overflow-hidden  font-poppins">
                ...
                <ParallaxText baseVelocity={-0.3} >
                    ...
                    <div className="flex items-center  py-3">
                        ...
                        <DivPart props={"Resume Builder & Analyser"} />
                        <DivPart props={"AI Based Mock Interviews"} />
                        <DivPart props={"Shastra AI"} />
                        <DivPart props={"Interaction Segment"} />
                        <DivPart props={"Personal Tracking"} />
                        <DivPart props={"Project Management"} />
                        <DivPart props={"Developers Toolkits"} />
                        <DivPart props={"Tech Blogs"} />
