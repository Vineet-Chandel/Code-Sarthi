...
"
 ...
 rounded-xl flex flex-col items-start justify-center py-5'  >
                ...
                <div className='w-full text-center p-6   flex flex-col items-center justify-center'>
                    ...
                    <div className='h-[30px] lg:h-[40px] mt-3  group font-bold text-sm  border-transparent mt-2 py-1 px-3 lg:px-5 bg-gradient-to-r from-green-300 via-emerald-300 to-teal-300 text-black rounded-3xl flex justify-center items-center inline-flex gap-1  cursor-pointer relative z-40' onClick={() => navigate("/login")} >
