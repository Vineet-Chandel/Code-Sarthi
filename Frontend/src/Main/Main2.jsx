...
const Main2 = () => {
    ...
    const range = isMobile ? [0, 0.25] : [0, 0.5];
...
"
    ...
    bg-[size:40px_40px] rounded-xl flex flex-col items-start justify-center py-5'  >
                ...
                <div className='w-full text-center py-10 sm:py-15  flex flex-col items-center justify-center'>
                    ...
                    <div className='h-[30px] lg:h-[40px]  group font-bold text-sm  border-transparent mt-2 py-1 px-3 lg:px-5 bg-gradient-to-r from-green-300 via-emerald-300 to-teal-300 text-black rounded-3xl flex justify-center items-center inline-flex gap-1  cursor-pointer' onClick={() => navigate("/login")} >
                ...
                <motion.div
                    style={isMobile ? mobileAnimation : desktopAnimation}
                    className="
        h-auto
        w-fit
        p-2
