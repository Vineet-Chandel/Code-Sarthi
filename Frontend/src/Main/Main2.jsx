...
const Main2 = () => {
    ...
    const z = useTransform(scrollYProgress, [0, 0.25], [-300, 0]);
    ...
    return (
        <div
            ref={container} className=' w-full bg-gray-200 p-1.5 [perspective:1500px]'>
    ...
    bg-[size:40px_40px] rounded-xl flex flex-col items-start justify-center py-5'  >
                <Nav />
                <div className='w-full text-center mt-[50px] lg:mt-[100px] flex flex-col items-center justify-center'>
                    ...
                    <div className="text-[#939393] w-3/4 md:w-1/2 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl md:mt-2 lg:mt-5">
                    ...
                    <div className='h-[30px] lg:h-[40px]  group font-bold text-sm  border-transparent mt-3 py-1 px-3 lg:px-5 bg-gradient-to-r from-green-300 via-emerald-300 to-teal-300 text-black rounded-3xl flex justify-center items-center inline-flex gap-1  cursor-pointer' onClick={() => navigate("/login")} >
                ...
                <motion.div
                    ...
                    className='h-auto w-fit p-2 sm:p-3 lg:p-5 mt-5  mx-3 sm:mx-5 lg:mx-10 xl:mx-20 rounded-3xl border border-gray-800 bg-white/20 '>
