...
const Settings = () => {
    ...
    return (
        <div data-theme="caramellatte " className="bg-black min-h-screen flex text-white relative overflow-hidden">
            <AnimatePresence>
                {/* LEFT SIDEBAR */}
                {isOpen && (
                    <motion.div
 ...
 flex flex-col gap-2 absolute z-20 left-0 top-0 border-r-[2px]"
                    ...
                    >
                        <div className="flex gap-6 justify-between mt-3 mb-3 items-center w-full">
                            <h2
                                className="text-xl sm:text-2xl lg:text-3xl font-bold text-transparent bg-gradient-to-r from-neutral to-secondary bg-clip-text flex items-center gap-5 group"
                        ...
                        <div className="relative mb-4">
                            ...
                            >
                                <g fill="none">
                                    ...
                                    <path stroke="#fff" strokeLinecap="round" d="M20.5 20.5L17 17" />
                                    <circle cx="11" cy="11" r="8.5" stroke="#fff" />
                                </g>
                            </svg>
      ...
      transition-all text-sm  placeholder:text-accent"
            ...
            >
                <div className="flex gap-2 items-center mb-3  bg-white w-fit px-3 py-2 rounded-3xl" >
                    <div className=" bg-white w-14 h-14 rounded-3xl flex  items-center justify-center ">

                        <div className="w-14 h-14  absolute z-10 ">
                            {!isOpen && (<div className="p-2 rounded-3xl w-full h-full flex items-center cursor-pointer justify-center border border-secondary border-[2px] bg-black/10" onClick={() => setIsOpen(true)}>
                                <svg xmlns="http://www.w3.org/2000/svg" width={28} height={28} viewBox="0 0 16 16">
                                    <path fill="#000" fillRule="evenodd" d="M0 3.75A.75.75 0 0 1 .75 3h14.5a.75.75 0 0 1 0 1.5H.75A.75.75 0 0 1 0 3.75M0 8a.75.75 0 0 1 .75-.75h14.5a.75.75 0 0 1 0 1.5H.75A.75.75 0 0 1 0 8m.75 3.5a.75.75 0 0 0 0 1.5h14.5a.75.75 0 0 0 0-1.5z" clipRule="evenodd"></path>
                                </svg>
                            </div>)}
                        </div>
                    </div>
                ...
                flex items-center gap-1 text-black">
                            ...
                            <svg className="rotate-90" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                <path fill="#000" d="M3 19h18a1.002 1.002 0 0 0 .823-1.569l-9-13c-.373-.539-1.271-.539-1.645 0l-9 13A.999.999 0 0 0 3 19"></path>
                            </svg> {active}
                        </h1>
                    </div>
                </div>
