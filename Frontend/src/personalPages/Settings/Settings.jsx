...
const Settings = () => {
    ...
    return (
        <div className="bg-[#0a0a0f] h-screen flex text-white relative overflow-hidden">
            ...
            {isOpen && (
                <div
                    className="h-full p-4 bg-[#05070c]/80 backdrop-blur-2xl border-r border-cyan-500/10 shadow-[10px_0_40px_rgba(0,0,0,0.6)]
          flex flex-col gap-2  absolute z-10"
            ...
            bg-gradient-to-r from-cyan-400 to-blue-500 font-mono flex items-center gap-2 group"
                        ...
                        >
                            <span className="text-3xl  group-hover:animate-[spin_2s_linear_infinite]"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
      ...
      transition-all text-sm font-mono placeholder:text-gray-600"
                    ...
                    <div className="flex-1 overflow-y-auto space-y-1 scrollbar-thin scrollbar-track-cyan-500/10 scrollbar-thumb-cyan-500/30">
                        <span className="text-xs uppercase tracking-wider text-gray-400 mt-4 mb-2 font-mono">User Settings</span>
                  ...
                  ${active === item.name
                        ...
                        <span className="text-xs uppercase tracking-wider text-gray-400 mt-4 mb-2 font-mono">App Settings</span>
                  ...
                  ${active === item.name
                        ...
                        <span className="text-xs uppercase tracking-wider text-gray-400 mt-4 mb-2 font-mono">Activity Settings</span>
                  ...
                  ${active === item.name
                        ...
                        <span className="text-xs uppercase tracking-wider text-gray-400 mt-4 mb-2 font-mono">Necessity</span>
                        ...
                        {filteredLogoutPart.map((item, index) => (
                            ...
                            >
                                <button
                                    ...
                                    id={`tab-${item.name}`}
                                    onClick={() => setActive(item.name)}
                                    className={`w-full relative px-4 py-3 mt-5  rounded-xl cursor-pointer
                  transition-all duration-300 group overflow-hidden
                  ${active === item.name
                                            ? "bg-gradient-to-r from-cyan-500/20 to-blue-600/20 border-2 border-cyan-400/50 shadow-[0_0_20px_rgba(0,255,255,0.2)]"
                                            : "hover:bg-white/5 border border-transparent"
          ...
          flex flex-col gap-2 ">
                    ...
                    {!isOpen && (<div className="bg-white/30 p-2 rounded-xl w-[50px]" onClick={() => setIsOpen(true)}>
