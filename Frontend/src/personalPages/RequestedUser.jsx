...
text-blue-500
    ...
    ">
                    ...
                    <span className="text-white">All Developers you Requested wait until they accept your Request  </span>
                </p>
            ...
            <div className="max-w-9xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-10">
                    {reqUser.map((item, index) => (
                        <div
                            key={item._id}
                            className=" relative group bg-[#212121]  rounded-3xl  before:absolute before:inset-0 before:rounded-3xl before:bg-gradient-to-br before:from-blue-500/[0.05] before:to-purple-500/[0.05] before:opacity-0 group-hover:before:opacity-100 before:transition-opacity">
...
"
                                    ...
                                    <div className="grid grid-cols-2 gap-2 w-full">
                                        <div className="text-center p-2 bg-white/10 border border-[2px] border-secondary rounded-lg">
                                    ...
                                    {/* Connection status */}
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-white/10 border border-[2px] border-secondary rounded-full">
                                ...
                                <div className="flex-1 space-y-4">
                                    ...
                                    <div className="flex justify-end  flex-wrap gap-3 pt-2">
                                        ...
                                        <button className="relative group w-fit bg-white/10 text-white/50 px-4 py-2.5 rounded-full font-medium hover:from-purple-500 hover:to-purple-600 transition-all duration-300   border border-secondary border-[2px] overflow-hidden" onClick={() => deleteRequest(item._id)}>
                                                ...
                                                {deletingId === item._id ? (
                                                    ...
                                                    <div className="w-full mx-auto flex justify-center text-red-500">
                                                        <motion.div
                                                            ...
                                                            className="w-8 h-8 border  border-[3px]  border-red-500  rounded-xl"  >
                                                    ...
                                                    (<div className="text-white hover:text-red-500 flex items-center justify-center gap-2 transition-all duration-300"><svg xmlns="http://www.w3.org/2000/svg" width={35} height={35} viewBox="0 0 40 40">
                                                        <g fill="none" strokeMiterlimit={10}>
                                                            <path fill="currentColor" d="M.5 20a19.5 19.5 0 1 0 39 0a19.5 19.5 0 0 0-39 0Z" strokeWidth={1}></path>
                                                            <path fill="#000" d="M30.08 25.41c-.16-.77-2.31-3.15-4.48-5.41c2.17-2.26 4.32-4.64 4.48-5.41c.46-.89-.63-2.11-1.59-3.08s-2.19-2-3.08-1.59c-.77.16-3.15 2.31-5.41 4.48c-2.26-2.17-4.64-4.32-5.41-4.48c-.89-.46-2.11.63-3.07 1.59s-2.06 2.19-1.6 3.08c.16.77 2.31 3.15 4.48 5.41c-2.17 2.26-4.32 4.64-4.48 5.41c-.46.89.63 2.11 1.59 3.08s2.19 2.05 3.08 1.59c.77-.16 3.15-2.31 5.41-4.48c2.26 2.17 4.64 4.32 5.41 4.48c.89.46 2.11-.63 3.08-1.59s2.05-2.19 1.59-3.08Z" strokeWidth={1}></path>
                                                            <path stroke="#ffffff" strokeLinecap="round" d="M27.56 5a15.4 15.4 0 0 1 5.26 3.73" strokeWidth={1}></path>
                                                        </g>
                                                    </svg>   Delete Request </div>)}
    ...
    bg-[#212121]
                ...
                animate-[modalPop_0.3s_ease]">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {/* ICON */}
                            <div className="w-[100px] h-[100px] flex items-center justify-center rounded-full bg-white/10 border border-secondary border-[3px]">
