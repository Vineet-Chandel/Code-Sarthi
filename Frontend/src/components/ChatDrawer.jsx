...
const ChatDrawer = ({ setShowCreateTab, showCreateTab, selectedChatUser2 }) => {
    return (
        <AnimatePresence>
            {showCreateTab && (
                <div className='absolute inset-0 w-full bg-black/30 h-[calc(100vh-65px)]' onClick={() => setShowCreateTab(false)}>
                    <motion.div
                        ...
                        className="absolute top-20 right-3 -translate-x-1/2  bg-white py-4 pr-4 rounded-xl shadow-xl z-50 w-50"
                    >
