...
group-hover:after:w-full font-bold font-poppins">
                ...
                < div className="NavEnd relative flex gap-1 min-[430px]:gap-2 sm:gap-3 justify-center items-center w-auto " >
                    ...
                    {activePage === "Discussions" && selectedChatUser.info !== null && < div onClick={() => setSelectedChatUser({ info: null })} className="relative md:hidden flex  items-center bg-[#212121] p-2 rounded-full justify-center text-white/50 hover:text-[#fff] transition-all duration-300">
