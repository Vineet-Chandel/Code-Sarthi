        ...
        <div className="navbar bg-gray-100 shadow-sm flex items-center justify-between ">
            ...
            <div className="NavStart flex justify-center items-center gap-2.5">
                ...
                <div className="logo flex justify-center items-center gap-4">
                    <button onClick={() => { navigate("/app"), setActivePage("Dashboard") }} className="h-8 w-8 rounded-full overflow-hidden bg-gradient-to-br from-gray-400 to-gray-100 cursor-pointer transition-all duration-300 hover:shadow-[0_10px_25px_rgba(0,0,0,0.1)] hover:scale-110 active:scale-95 focus:outline-none focus:ring-2 focus:ring-blue-400 flex justify-center items-center">
