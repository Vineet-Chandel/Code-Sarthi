...
const Welcome = () => {
    ...
    useEffect(() => {
        // High-fidelity progress interval
        const interval = setInterval(() => {
            setProgress((prev) => {
                if (prev >= 100) {
                    clearInterval(interval);
                    // Initiate smooth sequence exit right after loader finishes
                    setTimeout(() => setIsExiting(true), 400);
                    setTimeout(() => navigate("/app"), 1600);
                    return 100;
                }
                // Variable increments create a more organic, humanized loading feel
                const remaining = 100 - prev;
                const step = remaining > 50 ? 1.5 : remaining > 20 ? 1 : 0.75;
