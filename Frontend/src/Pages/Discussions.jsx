...
const Discussions = () => {
    ...
    transition-transform duration-200 hover:scale-110"
                                            ...
                                            <div className="relative max-w-[70%] group">
                                                ...
                                                <div className="bg-[#1A1A22] text-white 
    px-4 py-2.5 
...
hover:bg-white/10 active:scale-95`} onClick={() => { setActiveEmojiFeild("smileys_people"); setActiveEFeild("Smileys & Peoples"); }}>
                            ...
                            <div className="border-t border-white/10 p-3 md:p-4 bg-white/[0.03] backdrop-blur-2xl">
                                ...
                                <div className="flex items-center gap-3 ">
                                    ...
                                    <button
                                        onClick={sendMessage}
                                        className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-5 py-3 rounded-xl text-white text-sm font-medium transition-all duration-300   flex items-center gap-2 group"
                                    >
                                        <span>Send</span>
