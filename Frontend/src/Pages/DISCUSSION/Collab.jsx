...
const Collab = () => {
  ...
  return (
    <div className='h-[calc(100vh-65px)] w-screen bg-white flex gap-2 justify-center items-center p-2 '>
    ...
    bg-[size:40px_40px]  flex justify-center items-center flex-col'>
        ...
        <svg className='w-[400px] h-[400px]  ' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="4" y="6" width="16" height="12" rx="2" fill="#7E869E" fill-opacity="0.25" stroke="#fffefeff" stroke-width="1.2" />
        ...
        <h1 className='text-4xl font-extrabold font-poppins relative text-center -top-[80px] text-info'>
