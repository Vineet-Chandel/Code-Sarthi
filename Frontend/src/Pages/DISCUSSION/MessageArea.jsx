                            ...
                            {items.sender === "user1" ? (
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        className={`max-w-[45%] break-all whitespace-pre-wrap overflow-hidden   [word-break:break-word] min-w-[10%] flex   font-poppins ${items.text.length > 40 ? "flex-col items-end gap-2" : "items-center gap-3 flex-row"} bg-white text-black py-3 px-5    ${isSingle ? singleClass : isFirst ? firstClass : isMiddle ? middleClass : isLast ? lastClass : ""}`}>
