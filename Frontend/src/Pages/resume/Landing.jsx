...
const Landing = () => {
    return (
        <div className=' w-screen p-10 flex' >
            ...
            <div className='w-[50%] mt-5 bg-base-100 rounded-xl pl-10 pt-10 '>
                ...
                <div className='flex gap-5 mt-10'>
                    <button className='text-center h-15 text-lg w-45 font-extrabold transition duration-200 hover:scale-110 rounded-3xl bg-secondary p-5 text-secondary-content flex justify-center items-center '>
                        Import Resume
                    </button>
                    <button className='text-center h-15 text-lg w-45 font-extrabold transition duration-200 hover:scale-110 rounded-3xl bg-secondary p-5 text-secondary-content flex justify-center items-center '>
                        Create Resume
                ...
                <div className='mb-20'>
                    <div className='text-start h-15 text-lg w-45 font-extrabold transition duration-200 hover:scale-110 rounded-3xl bg-primary p-5 text-primary-content flex  flex-col justify-cneter items-start  mt-10' >
                        ...
                        <div className='flex justify-center w-full'><div className='text-start  text-md w-45  transition duration-200 hover:scale-110 rounded-3xl bg-primary p-5 text-primary-content flex justify-start items-center ' >Describe your role in a few words, and we'll generate tailored content for your work experience section.</div></div>
            ...
            <div className='w-[50%] mt-5 bg-base-100 rounded-xl p-5'>
