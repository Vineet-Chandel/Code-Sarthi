...
const IssueLinksModal = ({ isOpen, onClose, issue, myRole, onAddLink, onRemoveLink, onEditLink, loading }) => {
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-neutral-400 truncate max-w-[250px] sm:max-w-md">
                                        {issue?.title ? `Attached resources for ${issue.title}` : 'Manage attached URLs'}
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
