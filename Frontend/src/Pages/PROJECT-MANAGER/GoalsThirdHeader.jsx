...
const GoalsThirdHeader = ({ count, viewMode = 'grid', setViewMode }) => {
    return (
        <div className='flex flex-col sm:flex-row sm:justify-between items-stretch sm:items-center gap-3 my-4 bg-white/[0.03] rounded-2xl px-4 sm:px-6 py-3.5 transition-all'>
