...
const Collab = ({ resumeData }) => {
  ...
  return (
    ...
    <div className="w-full h-screen bg-white p-2  ">
      ...
      <div
        className="w-full min-h-screen  bg-black rounded-xl flex items-center justify-between gap-2 ">
    ...
    bg-[size:60px_60px] min-h-[700px] h-auto md:h-fit lg:min-h-[700px]  w-full lg:w-1/3 rounded-xl flex flex-col md:flex-row lg:flex-col gap-3 p-3">
            ...
            <div className="h-full z-20 w-full md:w-1/2 lg:w-full lg:h-1/2 bg-gray-200 rounded-xl px-5 pt-5" >
              ...
              <div className="w-full  flex justify-center items-center flex-col">
                ...
                <div className="relative w-full   flex items-start justify-center">
                  <img className="w-[200px] h-[200px] object-cover rounded-full" src={user?.user?.DATA?.photoUrl?.url} alt="" />
                  <svg className="absolute top-0 right-0 " xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" viewBox="0 0 24 24">
                    <g fill="#000">
                ...
                <h2 className="text-2xl mt-1 font-extrabold text-black ">
                ...
                <p className="text-lg  mb-2 font-bold text-accent ">
                  ...
                  {data.location ? (<span className="flex items-center gap-1" > <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Kanpur{data.pincode ? `, ${data.pincode}` : ""}  </span>
                  ) : (
            ...
            <div className="h-full z-20 pl-5 pr-5 md:w-1/2 lg:w-full lg:h-1/2  rounded-xl bg-black/20 backdrop-blur-sm  border border-white/10" >
              <div className="relative z-10 mt-9 mb-9">
                ...
                <p className="mt-3 mb-2 w-[90%] text-lg leading-[1.6] font-normal text-zinc-400">
                  {data.summaryBody ? (
                 ...
                 gap-2 bg-white/10 p-2 rounded-full items-center">
                  ...
                  {data.github && (
                    ...
                    <motion.div
                      ...
                      className="flex items-center justify-center  h-11 w-11 rounded-full text-lg border bg-gray-400/40 mx-auto cursor-pointer group border-white/10 font-extrabold font-poppins">
                      ...
                      <motion.svg
                        ...
                        className="group-hover:scale-110 transition-all duration-500" xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" viewBox="0 0 24 24">
            ...
            <div className="h-fit h-auto w-full  bg-green-500 rounded-xl ">
              <div className="relative h-full overflow-hidden rounded-xl border border-zinc-800 bg-gradient-to-b from-zinc-900/80 to-black p-4 sm:p-6">
                ...
                <div className="relative h-full  flex flex-col justify-center items-start">
                  <h2 className="text-xl sm:text-2xl font-extrabold font-poppins gap-1 text-white mb-2 sm:mb-4 items-center  flex">
                  ...
                  {data.skills ? (data?.skills?.map((item, idx) => (
                    ...
                    <div className="text-2xl  text-gray-400 w-full justify-center flex items-center font-extrabold">
                      NO SKILLS ADDED YET
                    </div>
                  }
                </div>
            ...
            <div className="h-fit h-auto w-full  bg-red-500 rounded-xl ">
              <div className="relative h-full overflow-hidden rounded-xl border border-zinc-800 bg-gradient-to-b from-zinc-900/80 to-black p-4 sm:p-6">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#27272a_0%,transparent_60%)] opacity-50" />

                <div className="relative h-full  flex flex-col justify-center items-start">
                  <h2 className="text-xl sm:text-2xl font-extrabold font-poppins gap-1 text-white mb-4 sm:mb-6 items-center  flex">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 16 16">
                      <path fill="#fff" d="M3 2h10c1.103 0 2 .897 2 2v6c0 1.103-.897 2-2 2H6.62A3.97 3.97 0 0 0 8 9a3.97 3.97 0 0 0-1.38-3h4.88a.5.5 0 0 0 0-1H4a3.97 3.97 0 0 0-3 1.38V4c0-1.103.897-2 2-2m6.5 7h2a.5.5 0 0 0 0-1h-2a.5.5 0 0 0 0 1M4 12a3 3 0 1 0 0-6a3 3 0 0 0 0 6m-2 2.5v-2.057a3.96 3.96 0 0 0 2 .556c.732 0 1.409-.212 2-.556v2.056a.5.5 0 0 1-.264.441a.5.5 0 0 1-.513-.024L4 14.1l-1.223.815A.497.497 0 0 1 2 14.5"></path>
                    </svg> Certifications
                  </h2>
                  {data.certifications ? (
                    data?.certifications.map((item, idx) => (
                      < p key={idx} className="flex flex-col items-start text-base sm:text-lg font-extrabold text-white">
                        ...
                        <span className="font-extralight pl-5"> {item.link}</span></p>
                    ))
            ...
            <div className="h-fit h-auto w-full  bg-yellow-500 rounded-xl ">
              <div className="relative h-full overflow-hidden rounded-xl border border-zinc-800 bg-gradient-to-b from-zinc-900/80 to-black p-4 sm:p-6">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#27272a_0%,transparent_60%)] opacity-50" />
                ...
                <div className="relative h-full  flex flex-col justify-center items-start">
                  ...
                  <p className="flex flex-col items-start text-base sm:text-lg font-extrabold text-white">
                    ...
                    <span className="font-extralight pl-5"> Proficient</span></p>
                  <p className="flex flex-col items-start text-base sm:text-lg font-extrabold text-white">
                    <span className="flex items-center gap-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 16 16">
                        <path fill="#fff" d="M8 9.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3"></path>
                    ...
                    <span className="font-extralight pl-5"> Native</span>
          ...
          <div className="flex lg:w-2/3 w-full h-full flex-col gap-2">
            <div className="flex flex-col md:flex-row items-stretch gap-2 w-full">
              ...
              <div className="h-fit h-auto bg-white w-full rounded-xl   overflow-hidden">
                <div className="relative z-10  p-5">
                  <h2 className="text-3xl flex flex-row items-center justify-start mb-4 font-extrabold tracking-tight text-black gap-1">
                  ...
                  <div className="bg-black/10 p-3 rounded-2xl">
                    <div className="flex items-center justify-between">
                      <div>
                        <h2 className="text-2xl mt-3 font-extrabold text-black ">
                          Experience1
                        </h2>
                        <p className="text-md  flex items-center gap-1 font-medium text-accent ">
                      ...
                      <div>
                        <div className=" text-black flex items-center justify-center  px-5 py-1 rounded-full text-lg border bg-gray-400/40 mx-auto   border-white/10 font-extrabold font-poppins">JOB TYPE</div>
                        <div className="text-black text-center text-xs mt-1">2025-01 - 2025-03</div>
                      </div>
                    </div>
                    <div className=" mt-2 pl-4 bg-black/20 rounded-2xl w-full py-2">
                      ...
                      <p className="text-black flex gap-2 ">
                        ...
                        </svg> Engineered responsive React UI, reducing load time 35% via lazy loading and SSR.</p>
                      <p className="text-black flex gap-2 ">

                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6.99811 10.2467L7.43298 11.0077C7.70983 11.4922 7.84825 11.7344 7.84825 12C7.84825 12.2656 7.70983 12.5078 7.43299 12.9923L7.43298 12.9923L6.99811 13.7533C5.75981 15.9203 5.14066 17.0039 5.62348 17.5412C6.1063 18.0785 7.24961 17.5783 9.53623 16.5779L15.8119 13.8323C17.6074 13.0468 18.5051 12.654 18.5051 12C18.5051 11.346 17.6074 10.9532 15.8119 10.1677L9.53624 7.4221C7.24962 6.42171 6.1063 5.92151 5.62348 6.45883C5.14066 6.99615 5.75981 8.07966 6.99811 10.2467Z" fill="#222222" />
                        </svg> Optimized RESTful API endpoints, cutting response latency 28% using Node.js and Redis caching.</p>
                      <p className="text-black flex gap-2 ">

                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6.99811 10.2467L7.43298 11.0077C7.70983 11.4922 7.84825 11.7344 7.84825 12C7.84825 12.2656 7.70983 12.5078 7.43299 12.9923L7.43298 12.9923L6.99811 13.7533C5.75981 15.9203 5.14066 17.0039 5.62348 17.5412C6.1063 18.0785 7.24961 17.5783 9.53623 16.5779L15.8119 13.8323C17.6074 13.0468 18.5051 12.654 18.5051 12C18.5051 11.346 17.6074 10.9532 15.8119 10.1677L9.53624 7.4221C7.24962 6.42171 6.1063 5.92151 5.62348 6.45883C5.14066 6.99615 5.75981 8.07966 6.99811 10.2467Z" fill="#222222" />
                        </svg> Automated CI/CD pipeline with GitHub Actions, accelerating deployment cycles 4x.</p>
                      <p className="text-black flex gap-2 ">

                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6.99811 10.2467L7.43298 11.0077C7.70983 11.4922 7.84825 11.7344 7.84825 12C7.84825 12.2656 7.70983 12.5078 7.43299 12.9923L7.43298 12.9923L6.99811 13.7533C5.75981 15.9203 5.14066 17.0039 5.62348 17.5412C6.1063 18.0785 7.24961 17.5783 9.53623 16.5779L15.8119 13.8323C17.6074 13.0468 18.5051 12.654 18.5051 12C18.5051 11.346 17.6074 10.9532 15.8119 10.1677L9.53624 7.4221C7.24962 6.42171 6.1063 5.92151 5.62348 6.45883C5.14066 6.99615 5.75981 8.07966 6.99811 10.2467Z" fill="#222222" />
                        </svg> Architected microservices architecture, enhancing scalability by 3x through Docker and Kubernetes.</p>
                      <p className="text-black flex gap-2 ">

                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6.99811 10.2467L7.43298 11.0077C7.70983 11.4922 7.84825 11.7344 7.84825 12C7.84825 12.2656 7.70983 12.5078 7.43299 12.9923L7.43298 12.9923L6.99811 13.7533C5.75981 15.9203 5.14066 17.0039 5.62348 17.5412C6.1063 18.0785 7.24961 17.5783 9.53623 16.5779L15.8119 13.8323C17.6074 13.0468 18.5051 12.654 18.5051 12C18.5051 11.346 17.6074 10.9532 15.8119 10.1677L9.53624 7.4221C7.24962 6.42171 6.1063 5.92151 5.62348 6.45883C5.14066 6.99615 5.75981 8.07966 6.99811 10.2467Z" fill="#222222" />
                        </svg> Secured user authentication flow, implementing OAuth2 and JWT, reducing breach risk 99%.</p>
                    </div>
                  </div>

                  <span className="flex items-center justif-center gap-2 mt-3 mb-3" >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="w-[60%]">
                        ...
                        <p className="text-sm mt-2 pl-3 gap-1 text-black w-full">
                          CodeSarthi connects you with a global developer community to build and scale. Designed to boost productivity while keeping workflows fast and efficient.
                        </p>
                      </div>
                      ...
                      <div>
                        <motion.div
                          ...
                          className="cursor-pointer text-black flex items-center justify-between  px-1  gap-2 py-1 rounded-full text-lg border bg-gray-400/40 mx-auto   border-white/10 font-extrabold font-poppins">

                          <div className="flex flex-row  items-center gap-2 border-r-2 pr-2 border-black text-sm">
                          ...
                          <div className="flex flex-row  items-center gap-2 text-sm">
                            Live Run
                            <div className="flex items-center justify-center  h-8 w-8 rounded-full text-lg border bg-gray-100 cursor-pointer group border-white/10 font-extrabold font-poppins">
                              <motion.svg
                                variants={iconVariants}
                                transition={{
                                  duration: 0.3,
                                ...
                                className="group-hover:scale-110 transition-all duration-500" xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" viewBox="0 0 16 16">
            ...
            <div className="flex flex-col md:flex-row items-stretch gap-2 w-full">
              <div className="h-fit h-auto w-full  bg-blue-500 rounded-xl">
                <div className="relative h-full overflow-hidden rounded-xl border border-zinc-800 bg-gradient-to-b from-zinc-600/50 to-black/50 p-4 sm:p-6">

                  <div className="relative z-10  p-3">
                    <h2 className="text-3xl flex flex-row items-center justify-start mb-4 font-extrabold tracking-tight text-white gap-1.5">
                      <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24">
                    ...
                    <div className="bg-black/10 p-3 rounded-2xl">
                      <div className="flex items-center justify-between">
                        <div>
                          <h2 className="text-2xl mt-3 font-extrabold text-white ">
                            Education1
                          </h2>
                        ...
                        <div>
                          <div className=" text-white flex items-center justify-center  px-5 py-1 rounded-full text-lg border bg-gray-400/40 mx-auto   border-white/10 font-extrabold font-poppins">JOB TYPE</div>
                          <div className="text-white text-center text-xs mt-1">2025-01 - 2025-03</div>
                        </div>
                      </div>
                      <div className=" mt-2 pl-4 bg-black/20 rounded-2xl w-full py-2">
                        ...
                        <p className="text-info flex gap-2 ">
