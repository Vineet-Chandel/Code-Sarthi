            ...
            <div className="relative z-10 flex-1 max-w-xl flex flex-col gap-6">
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-xs leading-relaxed" style={{ color: 'var(--color-accent)' }}>
                            Use expertly written suggestions to optimize* your skills section, or craft your own with AI writing help.
                        </p>
                    </div>
                </div>
                ...
                <div style={{ animation: 'fadeUp 0.55s ease 0.22s both' }}>
                    <div className="flex justify-between text-xs mb-2">
                        ...
                        <span className="font-bold" style={{ color: 'var(--color-secondary)' }}>37.5%</span>
                    </div>
                    ...
                    <div className="flex gap-3 mt-3 items-center">
                        {['Info', 'Experience', 'Education', 'Skills', 'Done'].map((label, i) => (
                            <div key={i} className="flex flex-col items-center gap-1">
                                <div
                                    ...
                                    style={{
                                        width: i === 3 ? '10px' : '7px',
                                        height: i === 3 ? '10px' : '7px',
                                        background: i <= 3 ? 'var(--color-neutral)' : 'var(--color-base-300)',
                                        outline: i === 3 ? '2px solid var(--color-secondary)' : 'none',
                                        outlineOffset: '2px',
                                    }}
                                />
                                <span className="text-[9px] font-medium" style={{ color: i <= 3 ? 'var(--color-base-content)' : 'var(--color-base-300)' }}>
                                    {label}
                                </span>
                            </div>
                        ))}
