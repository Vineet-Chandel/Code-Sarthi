  ...
  "
                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        >
                            Fix mistakes, rephrase bullet points,
                            or let AI draft from your notes.
                        </p>
                    </div>
                </div>
                    ...
                    >
                        <div
                            ...
                            style={{
                                width: `${progress}%`,
                                background:
                                    'linear-gradient(90deg,var(--color-info),var(--color-secondary-content))',
                                borderRadius: '999px',
                            }}
                        />
                    </div>
                ...
                ">
                        ...
                        {[
                            ...
                            >
                                ...
                                "
                                    style={{
                                        width: i === step - 1 ? '10px' : '7px',
                                        height: i === step - 1 ? '10px' : '7px',
                                        background:
                                            i <= step - 1
                                                ? 'var(--color-info)'
                                                : 'gray',
