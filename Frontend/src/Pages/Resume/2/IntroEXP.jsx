            ...
            <div className="relative z-10 flex-1 max-w-xl flex flex-col gap-6">
                ...
                <div style={{ animation: 'fadeUp 0.55s ease 0.22s both' }}>
                    <div className="flex justify-between text-xs mb-2">
                        ...
                        <span className="font-bold" style={{ color: 'var(--color-secondary)' }}>12.5%</span>
                    </div>
                            ...
                            <div key={i} className="flex flex-col items-center gap-1">
                                <div
                                    ...
                                    style={{
                                        width: i === 1 ? '10px' : '7px',
                                        height: i === 1 ? '10px' : '7px',
                                        background: i <= 1 ? 'var(--color-neutral)' : 'var(--color-base-300)',
                                        outline: i === 1 ? '2px solid var(--color-secondary)' : 'none',
                                        outlineOffset: '2px',
                                    }}
                                />
