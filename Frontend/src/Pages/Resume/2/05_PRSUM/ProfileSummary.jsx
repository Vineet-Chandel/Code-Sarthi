    ...
    return (
      ...
      `}
        ...
        "
                ...
                {/* ── footer ── */}
                <div className="flex gap-3 items-center justify-end px-6 md:px-10 py-4 bg-base-200 border-t border-slate-700">
                    <button className="bg-base-100  px-10 py-2.5 rounded-xl text-info font-bold border-2 border-secondary hover:text-secondary-content hover:border-secondary-content active:scale-95 transition-all duration-200" onClick={saveSummary}>
                        Save
                    </button>
                    <button
                        onClick={() => {
