                            ...
                            <div key={i} className="flex flex-col items-center gap-1">
                                <div
                                    ...
                                    style={{
                                        width: i === 1 ? '10px' : '7px',
                                        height: i === 1 ? '10px' : '7px',
                                        background: i <= 1 ? 'var(--color-info)' : 'gray',
                                        outline: i === 1 ? '2px solid var(--color-info)' : 'none',
                                        outlineOffset: '2px',
                                    }}
                                />
                                <span className="text-[11px] font-medium" style={{ color: i <= 2 ? 'var(--color-base-content)' : 'gray' }}>
                                    {label}
                                </span>
                            </div>
                        ))}
