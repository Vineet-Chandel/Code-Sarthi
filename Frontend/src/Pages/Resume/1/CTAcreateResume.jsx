...
const CTAcreateResume = () => {
    ...
    return (
        <div className='flex gap-5 mt-10'>
            <div className='border-4  border-transparent  border-dashed p-1 hover:border-secondary rounded-3xl    transition duration-200 flex justify-center items-center '>
