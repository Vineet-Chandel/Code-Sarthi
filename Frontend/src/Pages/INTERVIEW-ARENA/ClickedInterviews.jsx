...
const ClickedInterviews = ({ clicked2, setClicked2 }) => {
                                ...
                                <span className=" flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 ">
                                    ...
                                    <button
                                        onClick={() => {
                                            ...
                                            setClicked2(false); setBroadRoleopen(true); setSpecificRoleOpen(false)
                                        }}
                                        className="
                                ...
                                <span className=" flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 ">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 mt-2">
                                            Please Complete the Full Career Profile below the previous pannel before generating the interview
                                        </p>
                                    </div>
...
export default ClickedInterviews