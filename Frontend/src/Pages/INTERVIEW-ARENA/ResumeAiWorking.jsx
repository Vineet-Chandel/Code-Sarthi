        ...
        <div className=" w-full flex flex-col justify-start  gap-5 px-2 items-center ">
            ...
            {RESUME_PIPELINE_STAGES.map((items, idx) => {
                return (<motion.div key={idx}
                    ...
                    className="w-[80%]  bg-black/20 border border-black/25 rounded-2xl flex flex-col items-center justify-center overflow-hidden"  >
                    {/* loading status */}
                    ...
                    <AnimatePresence initial={false}>
                        {stageOpen === idx && (
                            ...
                            >
                                <div className="bg-black text-gray-200 p-6   rounded-lg">
                                    {items.description}
