export const RESUME_PIPELINE_STAGES = [
    {
        id: "stage_0",
        stageNumber: 0,
        key: "audit",
...

    {
        ...
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 8L8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7L16 8" stroke="#000" strokeWidth="2" strokeLinecap="round" />
