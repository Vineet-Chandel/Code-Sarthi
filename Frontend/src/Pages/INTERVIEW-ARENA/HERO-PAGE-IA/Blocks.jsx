...
const Blocks = () => {
    ...
    ">
                ...
                <p className="mt-1 max-w-3xl mx-auto text-gray-400 text-base">
                    From resume creation to mock interviews, Chakravyūha AI
                    prepares you for every stage of the hiring battlefield.
                </p>
            </div>
            <div className='w-[95%] mx-auto h-full bg-base-100 rounded-xl '>
...
transition-all
duration-500
" onClick={() => Navigate("chakra")}>  <svg className='rotate-45 group-hover:rotate-90 transition duration-500 ' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
